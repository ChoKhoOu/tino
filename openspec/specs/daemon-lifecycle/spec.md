...
Manages the engine daemon lifecycle — CLI process registration via lock files, automatic engine start/stop, watchdog health monitoring, shutdown coordination, and monorepo root discovery.
