# Capability: Live Trading Display

## Purpose

Provides real-time visual display for live and paper trading sessions, including mode differentiation banners, trade execution notifications, position updates, risk alerts, circuit breaker events, session state changes, global kill switch shortcut, and deployment confirmation gates.
