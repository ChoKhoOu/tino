# Capability: Input Experience

## Purpose

Provides a rich text input experience for the CLI, including multi-line editing, persistent command history, input clearing, paste support, and visual prompt states.
